  ...
  plugins: [
    polar({
      ...
      use: [
        checkout({
          products: [
            // Starter tier (fallback)
            ...(process.env.NEXT_PUBLIC_STARTER_TIER && process.env.NEXT_PUBLIC_STARTER_SLUG
              ? [
                  {
            ...
            ...(process.env.NEXT_PUBLIC_MONTHLY_TIER && process.env.NEXT_PUBLIC_MONTHLY_SLUG
              ? [
                  {
                    productId: process.env.NEXT_PUBLIC_MONTHLY_TIER,
                    slug: process.env.NEXT_PUBLIC_MONTHLY_SLUG,
                  },
                ]
              : []),
            // Yearly subscription tier
            ...(process.env.NEXT_PUBLIC_YEARLY_TIER && process.env.NEXT_PUBLIC_YEARLY_SLUG
              ? [
                  {
                    productId: process.env.NEXT_PUBLIC_YEARLY_TIER,
                    slug: process.env.NEXT_PUBLIC_YEARLY_SLUG,
                  },
                ]
              : []),
          ],
